  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="flex">
        ...
        {/* Right Sidebar - All Contacts */}
        <div className="w-96 bg-white border-l border-gray-200 p-6">
          <div className="flex items-center justify-between mb-6">
            <h3 className="font-semibold text-gray-900 text-lg">All Contacts (398)</h3>
            <Button variant="ghost" size="sm">
          ...
          <div className="space-y-4">
            {[
              { id: '1', name: 'chris', fullName: 'chris', type: 'Academic Support', next: 'Su 12:03 2:30 pm', status: 'Active', avatar: 'C' },
              { id: '2', name: 'blue bird', fullName: 'blue bird', type: 'Career Guidance', next: 'Mo 14:30 3:00 pm', status: 'Pending', avatar: 'BB' },
              { id: '3', name: 'Adama andrew', fullName: 'Adama andrew', type: 'Customer call', next: 'Su 12:03 2:30 pm', status: 'Created', avatar: 'AA' },
              { id: '4', name: 'Andrew Sal', fullName: 'Andrew Sal', type: 'Flow up mail', next: 'Su 12:03 2:30 pm', status: 'Was Assigned', avatar: 'AS' },
              { id: '5', name: 'Arago Stan', fullName: 'Arago Stan', type: 'Customer call', next: 'Su 12:03 2:30 pm', status: 'Created', avatar: 'AS' },
              { id: '6', name: 'Attard Mark', fullName: 'Attard Mark', type: 'Flow up mail', next: 'Su 12:03 2:30 pm', status: 'Add search', avatar: 'AM' },
              { id: '7', name: 'Hagan Azon', fullName: 'Hagan Azon', type: 'Flow up mail', next: 'Su 12:03 2:30 pm', status: 'Add search', avatar: 'HA' }
            ].map((contact) => (
              <div key={contact.id} className="bg-white rounded-lg p-4 hover:bg-gray-50 transition-colors border border-gray-100">
                <div className="flex items-center justify-between mb-3">
                  <div className="flex items-center space-x-3">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-xs text-gray-600 mt-1">{contact.type}</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-2 ml-13">
                  <div className="flex items-center justify-between text-xs">
                    ...
                    <span className="font-medium text-gray-900">{contact.next}</span>
                  </div>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <Badge 
                      className={cn(
                        ...
                        contact.status === 'Pending' && "bg-orange-100 text-orange-700 border-orange-200",
                        contact.status === 'Created' && "bg-blue-100 text-blue-700 border-blue-200",
                        contact.status === 'Was Assigned' && "bg-gray-100 text-gray-700 border-gray-200",
                        contact.status === 'Add search' && "bg-purple-100 text-purple-700 border-purple-200"
                      )}
                    >
                      {contact.status}
                    </Badge>
          ...
          <Button variant="outline" className="w-full mt-6 text-gray-600 border-gray-200 h-10">
            Add search
          </Button>
        </div>
      </div>
